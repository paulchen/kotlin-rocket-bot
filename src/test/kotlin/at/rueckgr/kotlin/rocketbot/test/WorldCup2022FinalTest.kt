...
class WorldCup2022FinalTest : FixtureTest(
    ...
    expectedStateChanges = listOf(
        ...
        446 to "Pause vor Elfmeterschießen; Spielstand: 3\uFEFF:\uFEFF3 n.V. (3\uFEFF:\uFEFF3, 2\uFEFF:\uFEFF0)",
    ...
    expectedEvents = listOf(
        ...
        465 to "Elfmetertreffer für :flag_fr:\u00A0*Frankreich* durch Randal Kolo Muani; Spielstand: 3\uFEFF:\uFEFF3 n.V. (2\uFEFF:\uFEFF2, 2\uFEFF:\uFEFF0), 3\uFEFF:2 i.E.)",
        465 to "Elfmetertreffer für :flag_ar:\u00A0*Argentinien* durch Gonzalo Montiel; Spielstand: 3\uFEFF:\uFEFF3 n.V. (2\uFEFF:\uFEFF2, 2\uFEFF:\uFEFF0), 4:2 i.E.)"
    )
)

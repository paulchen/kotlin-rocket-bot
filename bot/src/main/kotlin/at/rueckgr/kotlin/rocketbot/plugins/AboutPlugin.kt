...
class AboutPlugin : AbstractPlugin() {
    override fun getCommands(): List<String> = emptyList() // listOf("about")

    override fun handle(channel: EventHandler.Channel, user: EventHandler.User, message: EventHandler.Message): List<OutgoingMessage> = emptyList()
